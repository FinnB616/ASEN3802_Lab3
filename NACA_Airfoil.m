...
% %create n/2 different x positions (original)
% x_positions = linspace(0,c,round(N/2));

% equiangular spacing (cosine clustering)
theta = linspace(0, pi, round(N/2)+1);
x_positions = (c/2)*(1 - cos(theta));
